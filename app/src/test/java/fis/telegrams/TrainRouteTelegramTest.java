...
public class TrainRouteTelegramTest {
	...
	public void setup(){
		...
		this.stops1.add(new Stop(dresden_neustadt, StopType.BEGIN, LocalTime.of(13, 37), LocalTime.of(13, 38), "3"));
		this.stops1.add(new Stop(dresden, StopType.PASS, LocalTime.of(14, 37), LocalTime.of(14, 38), "3"));
		this.stops1.add(new Stop(tharandt, StopType.PASS, LocalTime.of(15, 37), LocalTime.of(15, 38), "3"));
		this.stops2 = new ArrayList<Stop>();
		this.stops2.add(new Stop(klingenberg, StopType.PASS, LocalTime.of(16, 37), LocalTime.of(16, 38), "3"));
		this.stops2.add(new Stop(freiberg, StopType.PASS, LocalTime.of(17, 37), LocalTime.of(17, 38), "3"));
		this.stops2.add(new Stop(chemnitz, StopType.END, LocalTime.of(18, 37), LocalTime.of(18, 38), "3"));
