...
public class TelegramReceiverController extends Thread implements ApplicationEventPublisherAware, SmartLifecycle {
     ...
     * 
     * @param config
     *            eine TelegramReceiverConfig mit Verbindungsdaten und timeouts
     * @param server
     *            ein Socket zur Verbindung mit dem Server
     * @param receiver
     *            ein TelegramReceiver
     * @param parser
     *            ein TelegramParser
     */
    @Autowired
     ...
     *             bei ungültiger Verbindungskonfiguration
     */
