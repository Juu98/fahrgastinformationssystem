...
public class TrainRouteComparator implements Comparator<TrainRoute> {
     ...
     * 
     * @param station
     *            The {@link Station} at which the times should be compared
     * @param filterTime
     *            Whether to compare the scheduled or actual times
     * @param filterType
     *            Whether to compare arrival or departure times,
     ...
     * 
     * @param o1
     *            first {@link TrainRoute}
     * @param o2
     *            second {@link TrainRoute}
