...
|U-XML-railml2data-2|loadML|Geparste Railml-Daten in die eigene Datenstruktur bringen|RailMLParser, Data|gültiger Pfad+Datei|Übernahme in die eigene Datenstruktur
|*[U-XML-RailMLParser]*|||||
