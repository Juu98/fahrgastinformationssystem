...
Der Benuter ruft in einem Webbrowser das FIS auf. Er wählt per Texteingabe oder aus einer Liste einen Bahnhof aus und lässt sich Abfahrten oder Ankünfte für diesen Bahnhof anzeigen.
...
|Zeit 				|Stellt aktuelle ALborzeit dar
...
|6	|Auf beiden Tafeln kann der Zetraum eingegrenzt und nach Zuggattung gefiltert werden
