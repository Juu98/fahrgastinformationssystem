...
public class Application {
	...
	/**
	 * Some initializing code to pre-fill our database with {@link searchEntry}. The {@link PostConstruct} annotation
	 * is causing the Spring container to trigger the execution on application startup.
	 */
	@PostConstruct
	void initialize() {

		search.save(new searchEntry("H4xx0r", "first!!!"));
		search.save(new searchEntry("Arni", "Hasta la vista, baby"));
		search.save(new searchEntry("Duke Nukem",
				"It's time to kick ass and chew bubble gum. And I'm all out of gum."));
		search.save(new searchEntry("Gump1337",
