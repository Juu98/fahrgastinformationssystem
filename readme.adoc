...
Betreuung durch Ronny Kaiser (https://github.com/rks[@rks]), Lehrstuhl Softwaretechnologie, Institut für Software- und Multimediatechnik, Fakultät Informatik der TU dresden.
